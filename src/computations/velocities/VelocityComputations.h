...
public:
     ...
     * @param numThreads the number of threads to use for this simulation
     */
    static void applyBrownianMotion2D(ParticleContainer &particles, double averageVelocity, size_t numThreads);
     ...
     * @param numThreads the number of threads to use for this simulation
     */
    static void applyBrownianMotion3D(ParticleContainer &particles, double averageVelocity, size_t numThreads);
};
