...
class parameters: public ::xml_schema::type
{
  ...
  // averageVelocity
  //
  typedef ::xml_schema::double_ averageVelocity_type;
  typedef ::xsd::cxx::tree::optional< averageVelocity_type > averageVelocity_optional;
  typedef ::xsd::cxx::tree::traits< averageVelocity_type, char, ::xsd::cxx::tree::schema_type::double_ > averageVelocity_traits;

  const averageVelocity_optional&
  averageVelocity () const;

  averageVelocity_optional&
  averageVelocity ();
  ...
  averageVelocity_optional averageVelocity_;
