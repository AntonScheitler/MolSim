...
class ParticleContainer {
    ...
    public:
        ...
        /**
         * @brief returns a ParticleIterator which points to the beginning of the ParticleContainer
         * @return a ParticleIterator which points to the beginning of the ParticleContainer
         */
        ParticleIterator beginParticle();
        /**
         * @brief returns a ParticleIterator which points to the end of the ParticleContainer
         * @return a ParticleIterator which points to the end of the ParticleContainer
         */
